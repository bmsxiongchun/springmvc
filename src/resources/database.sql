...
insert into user values(null,'小明','1996-10-17','male', '北京市');

insert into user values(null,'xiong','1997-04-24','female', 'beijing');
insert into user values(null,'chen','1996-10-17','male', 'ssdfsf');

insert into user values(null,'xiong','1997-04-24','female', 'test');
...
select id, username, birthday from User where username like '%xiong' and sex='female' and id in (1, 2, 3);
...
insert into orders value(1, 1, 100, '1992-01-01', 'this is a note');
...
select items_id from mybatis.orderdetail;

delete from items where id in (1) and id not in (select items_id from mybatis.orderdetail);
